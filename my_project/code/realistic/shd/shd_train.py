"""Experiment 2A: SHD — Train on clean inputs, evaluate with hidden-layer perturbation.

Train a 2-hidden-layer SNN on SHD with unperturbed inputs, then evaluate
by applying spike-timing perturbation to the 1st hidden layer output at
...
class SHDNetwork(nn.Module):
    """2-hidden-layer SLAYER SNN for SHD classification with hidden-layer perturbation."""
