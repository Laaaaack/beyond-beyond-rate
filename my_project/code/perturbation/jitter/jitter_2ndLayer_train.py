...
2nd hidden layer output during evaluation only. This follows the branch-wide
train-clean / eval-perturbed protocol.

Per-spike jitter: each spike in the 2nd hidden layer output is independently
...
class JitterSHDNetwork(nn.Module):
    ...
    def forward_with_hidden_perturbation(
        ...
        # Eval-only: jitter the 2nd hidden layer spikes. Call inside
