...
from my_project.exp_perturbation_awared_training.code.test.diff_rate_test.doubled_rate.realistic.shd.utils import get_shd_dataset
...
# ==============================
# Doubled-rate variant: nb_steps=200 discretises the same [0, max_time] window
# into twice as many bins as the original (100), doubling the temporal sample
# rate of the dense SHD spike trains (T=200 instead of T=100).
def sparse_to_dense(X, y, nb_steps=200, nb_units=700, max_time=1.4, batch_size=256):
