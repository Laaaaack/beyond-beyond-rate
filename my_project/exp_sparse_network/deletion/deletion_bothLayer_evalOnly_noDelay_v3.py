"""v3 Phase 1 at BOTH LAYERS, NO-DELAY: deletion sweep, eval-only.
...
network's hidden spikes are deleted at evaluation only.
...
[the with-delay sibling](deletion_bothLayer_evalOnly_withDelay_v3.py). The arms
...
- writes ``log/sparse_whole_nodelay_v3L12_deletion_eval.json`` with
